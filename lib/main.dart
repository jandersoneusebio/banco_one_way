...
import 'package:banco_one_way/main.dart';
...
void main() => runApp(
  MaterialApp(
    ...
    routes: {
      "/" : (context) => Main(),
      "/transf" : (context) => TransfScreen(),
      "/deposito" : (context) => DepositoScreen(),
      "/extrato" : (context) => ExtratoScreen(),
      "/saque" : (context) => SaqueScreen()
    },

    theme: ThemeData(
      appBarTheme: AppBarTheme(color: marinho, brightness: Brightness.dark),
